...
// ImagePro_PView.h: CImageProPView 클래스의 인터페이스
//

#pragma once


class CImageProPView : public CScrollView
{
protected: // serialization에서만 만들어집니다.
	CImageProPView() noexcept;
	DECLARE_DYNCREATE(CImageProPView)

// 특성입니다.
public:
	CImageProPDoc* GetDocument() const;
...
#ifndef _DEBUG  // ImagePro_PView.cpp의 디버그 버전
inline CImageProPDoc* CImageProPView::GetDocument() const
   { return reinterpret_cast<CImageProPDoc*>(m_pDocument); }
#endif
